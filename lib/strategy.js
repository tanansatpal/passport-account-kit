...
function Strategy(options, verify) {
    options = options || {};
    options.loginType = options.loginType || "sms";
    options.authorizationURL = options.authorizationURL || (options.loginType === "sms" ? 'https://www.accountkit.com/v1.0/basic/dialog/sms_login' : "https://www.accountkit.com/v1.0/basic/dialog/email_login");
...
Strategy.prototype.userProfile = function (accessToken, done) {
    ...
    if (this._enableProof) {
        ...
        var proof = crypto.createHmac('sha256', this._appSecret).update(accessToken).digest('hex');
